<template>
  <v-data-table
    ...
    :items="students"
    :items-per-page="15"
    class="elevation-1 hogwartsTable"
    ...
    data () {
      return {
        ...
        headers: [
          ...
          { text: 'Eye Color', value: 'eyeColour' },
          { text: 'Hair Color', value: 'hairColour' },
          { text: 'Wand Type', value:'wand.wood'},
          { text: 'Wand Core', value:'wand.core'},
          { text: 'Wand length', value:'wand.length'},
